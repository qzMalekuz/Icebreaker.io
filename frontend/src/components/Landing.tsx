...
export default function Landing() {
  ...
  return (
    <div className="min-h-dvh bg-bg text-text-soft font-body overflow-x-hidden animate-page-in relative">
      {showReveal && <RevealModal onEnter={handleRevealEnter} />}

      {/* Atmosphere blobs */}
      <div className="fixed -top-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-[rgba(248,188,95,0.05)] blur-[120px] pointer-events-none z-0" />
      <div className="fixed -bottom-[10%] -right-[10%] w-[50%] h-[50%] rounded-full bg-[rgba(20,19,18,0.4)] blur-[120px] pointer-events-none z-0" />
      ...
      {/* Main */}
      <main className="relative z-10 pt-32 pb-24 px-6 max-w-container mx-auto min-h-screen flex flex-col justify-center md:px-12">
